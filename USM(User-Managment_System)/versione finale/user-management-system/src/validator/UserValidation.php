...
class UserValidation {
    ...
    public const PASSWORD_ERROR_REQUIRED = 'La password e\' obbligatoria';
    public const PASSWORD_ERROR_NONE = 'La password e\' corretta';
    ...
    private function validatePassword():?ValidationResult
    {
        ...
        if (empty($password)){
            return new ValidationResult(self::PASSWORD_ERROR_REQUIRED, false , $password);
        }
        else{
            return new ValidationResult(self::PASSWORD_ERROR_NONE , true , $password);
        }
    }
